...
public class perpustakaan_parodi {
    public static void main(String[] args) throws IOException {
        InputStreamReader isr = new InputStreamReader(System.in);
        BufferedReader br = new BufferedReader(isr);

        String[] adminUsername = {"admin1", "OKOWI", "admin2", "admin3"};
        ...
        String[] novel = new String[100];
        String[] komik = new String[100];
        ...
        if (isAdmin) {
            ...
            do {
                ...
                switch (MenuUtama) {
                    ...
                    case 2:
                        System.out.print("=========daftar jurnal=============== ");
                        String daftarjurnal = br.readLine();
                        System.out.println("jurnal '" + daftarjurnal + "' saat ini");
                        ...
                        String penerbit = br.readLine();
                        System.out.print("Tanggal terbit: ");
                        String tanggalterbit = br.readLine();

                        daftarJurnal[jurnalCount][0] = judul;
                        daftarJurnal[jurnalCount][1] = penulis;
                        daftarJurnal[jurnalCount][2] = penerbit;
                        daftarJurnal[jurnalCount][3] = tanggalterbit;
                        jurnalCount++;
                    ...
                    case 3:
                       System.out.println("Masukkan daftar novel baru: ");
                        String novelBaru = br.readLine();
                        System.out.println("Novel '" + novelBaru + "' berhasil ditambahkan.");
                        System.out.println("Daftar novel saat ini: ");
                        tampilkanDaftarNovel(daftarNovel);
                        System.out.println("1. Novel Fiksi");
                        System.out.println("2. Novel Non Fiksi");
                      
                        try {
                            System.out.print("Masukkan judul novel yang ingin ditambahkan: ");
                            String judulNovel = br.readLine();
                            System.out.print("Masukkan penulis novel: ");
                            String penulisNovel = br.readLine();
                            System.out.print("Masukkan tahun terbit novel: ");
                            String tahunTerbit = br.readLine();

                            // Simpan data novel ke dalam daftar
                            System.out.println("Novel '" + judulNovel + "' oleh " + penulisNovel + " (" + tahunTerbit + ") berhasil ditambahkan.");
                        } catch (IOException e) {
                    ...
                    case 4:
                        System.out.println("Pilih tema komik: ");
                        String komikBaru = br.readLine();
                        System.out.println("Komik " + komikBaru + " berhasil ditambah");
                        System.out.println("Daftar komik saat ini:");
                    ...
                    case 5:
                        ...
                        if (userUsername.equals("user") && userPassword.equals("user123")) {
                            ...
                            isAdminLoggedIn = false; // Keluar dari menu admin
                        } else {
                    ...
                    case 6:
                        ...
                        isAdminLoggedIn = false; // ini keluar dari menu admin
