                    ...
                    while (adminMenu) {
                        ...
                        switch (adminChoice) {
                            ...
                            case "2":
                                ...
                                daftarJurnal[indexJurnal++] = new String[]{kategoriJurnal,"7. ", judulJurnal, pengarangJurnal, penerbitJurnal, tahunJurnal, "Tersedia"};
                                System.out.println("Jurnal berhasil ditambahkan!");
                             
                                break;
                                
                            case "3":
                                //bagian penambahan Novel
                                System.out.print("Masukkan kategori: ");
                                ...
                                daftarNovel[indexNovel++] = new String[]{kategoriNovel,"7. ", judulNovel, pengarangNovel, penerbitNovel, tahunNovel, "Tersedia"};
                            ...
                            case "4":
                                ...
                                daftarKomik[indexKomik++] = new String[]{kategoriKomik,"7. ", judulKomik, pengarangKomik, penerbitKomik, tahunKomik, "Tersedia"};
                            ...
                            case "1":
                                ...
                                if (kategoriPilihan >= 0 && kategoriPilihan < tema.length) {
                                    ...
                                    if (subTemaPilihan >= 0 && subTemaPilihan < subTema[kategoriPilihan].length) {
                                        ...
                                        //ini untuk fakepoint biar output yang di klik sesuai sama yang di tampilkan
                                        ArrayList<Integer> indeksSementara = new ArrayList<>();

                                        //ini buat naro indeks aslinya trus dijadiin fake point
                                        for (int k = 0; k < indexBuku; k++) {
                                            if (daftarBuku[k][0].equals(subTema[kategoriPilihan][subTemaPilihan])) {
